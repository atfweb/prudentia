...
/**
 * @file
 * Custom theme setting form elements for the Prudentia theme.
 */
 ...
 */
function prudentia_form_system_theme_settings_alter(&$form, FormStateInterface &$form_state, $form_id = NULL) {
